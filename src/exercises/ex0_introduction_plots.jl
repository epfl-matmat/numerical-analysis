...
let
	...
	ys_points = [3.264219326544821, 3.4489309156347425, 12.975323123905081, 3.8904467103807927, 128.650270688119, 23.524783240700987, 175.52405606163614, 1173.8330021528288, 8755.08696752278, 11573.569080380066, 8807.211902252335]
	ys_line = exp.(xs)
	plot(xs, ys_line; label="1 line", linewidth=4)
	scatter!(xs, ys_points; label="11 points")
	plot!(; title="11 points and 1 line")
	plot!(; yscale=:log10, ylabel="y value. Did you notice the log scale?")
...
#=╠═╡
#= begin solution =#
linestyle_values = [:auto, :solid, :dash, :dot, :dashdot, :dashdotdot]
#= end soluton =#
  ╠═╡ =#
