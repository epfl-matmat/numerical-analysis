...
!!! info "Related questions we will discuss:"
	...
	- There seems to be some minimal error we can achieve. Are there more accurate derivative formulas ?
...
Well, unfortunately **for many realistic numerical settings** (e.g. the quantum-chemical simulation of materials) even **standard packages** such as NLsolve are **no longer able to automatically figure out the best solution strategy**. As a result developing some intuition for the required numerical procedure is very helpful.

Even if you now might think, that your heart beats for **experimental research** and you will never need numerics, keep in mind that **all data analysis** uses procedures **based on such techniques**. **Even commercial packages** for experimental post-processing rely heavily on the procedures we will cover and **sometimes get it wrong**. See for example this [report on Microsoft Excel](https://www.economist.com/graphic-detail/2016/09/07/excel-errors-and-science-papers). This **can and has compromised scientific findings in the past**. Therefore it's **best to be prepared**, so you can judge what is wrong: The experiment or the numerics.
"""
...
manifest_format = "2.0"
project_hash = "0868ac3046cc7f7bf9632e304f5cb501fe8a5391"
