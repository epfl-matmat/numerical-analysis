...
md"""
If $\lim_{k\to\infty} x^{(k)} = x_\ast$ for the sequence $x^{(k)}$ generated by Algorithm 1, then $g(x_ast) = x_\ast$, i.e. $x_\ast$ is a fixed point of $g$.
...
md"""
#### Visual inspection: Log of residual ratio
