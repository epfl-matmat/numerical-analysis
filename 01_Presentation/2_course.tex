\begin{frame}{Course organisation}
    \begin{itemize}
        ...
        \item \url{https://teaching.matmat.org/numerical-analysis/}
            ...
            \end{itemize}
        \vspace{1em}
        \item \alert{ED forum:} \url{https://edstem.org/eu/courses/2956}
            \begin{itemize}
                \vspace{-0.2em}
    ...
    \begin{itemize}
        ...
        \item Teaching assistants
            \begin{itemize}
                    ...
                    \vspace{0.1em}
                    \item \textbf{Dimitri Pelgrin}, \texttt{dimitri.pelgrin@epfl.ch}
                    \vspace{0.1em}
                    \item \textbf{Ghita Amrani}, \texttt{ghita.amrani@epfl.ch}
                    \vspace{0.1em}
                    \item \textbf{Ivan Krsic}, \texttt{ivan.krsic@epfl.ch}
                    \vspace{0.1em}
                    \item \textbf{Tomas Jouven}, \texttt{tomas.jouven@epfl.ch}
            \end{itemize}
    \end{itemize}
    \end{column}
    \end{columns}
...
\begin{frame}{Course materials}
    \begin{itemize}
        ...
        \item \textbf{Weekly} exercise sheets \textcolor{grey5}{\smaller[0.5](no submission)}
        \item \textbf{Graded} exercise sheet \alert{(submission mandatory)}
        \vspace{1.0em}
        \item \textbf{Further references} (see \href{https://go.epfl.ch/numerical-analysis}{Moodle}):
            \begin{itemize}
                \vspace{-0.2em}
            ...
            \end{itemize}
        \vspace{1.0em}
        \item \textbf{Recordings} on \href{https://mediaspace.epfl.ch/channel/numerical-analysis/110626}{https://mediaspace.epfl.ch}
            \begin{itemize}
                \vspace{-0.5em}
                \item Not complete \& a little outdated \textcolor{grey5}{\smaller[0.5](course curriculum changed)}
            \end{itemize}
    \end{itemize}
\end{frame}
